...
public interface ICDTLaunchConfigurationConstants {
	...
	public static final String ID_LAUNCH_C_APP = "com.arc.embeddedcdt.idleNative"; //$NON-NLS-1$
	/**
	 ...
	 * (value <code>"C/C++"</code>).
	 */
	public static final String ID_PROGRAM_PROCESS_TYPE = "ARC C/C++"; //$NON-NLS-1$ 
